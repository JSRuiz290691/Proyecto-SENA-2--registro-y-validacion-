...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, username, email, password, roles, newUser, foundRoles, _role, savedUser, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 12:
          ...
          newUser.roles = foundRoles.map(role._id); // se busca guardar un arreglo con los id de cada rol, y no los objetos, que recorra el foundRoles con el metodo map, y por cada objeto quiero que solo devuelvas el rol.id
          _context.next = 20;
          break;
        case 16:
          _context.next = 18;
        ...
        case 18:
          ...
          newUser.roles = [_role._id]; // se guarda en el nuevousuario el id del rol user como arreglo por que roles es un arreglo
        case 20:
          _context.next = 22;
          return newUser.save();
        case 22:
