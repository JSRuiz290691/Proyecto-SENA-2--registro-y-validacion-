...
var createUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, lastname, id, email, password, role, newUser, userSave;
      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          newUser = new _User["default"]({
            ...
            password: password,
            role: role
          }); // se guarda el nuevo usuario en la constante newUser
          _context.next = 4;
          return newUser.save();
        case 4:
          userSave = _context.sent;
          // se guarda el nuevo usuario en otra constante
  ...
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          _context2.next = 2;
          return _User["default"].find().populate('role');
        case 2:
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _User["default"].findById(req.params.userId).populate('role');
        case 2:
          user = _context3.sent;
...
var updateUserById = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    var _req$body2, name, lastname, id, email, password, role, userData, foundRole, updateUser;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _req$body2 = req.body, name = _req$body2.name, lastname = _req$body2.lastname, id = _req$body2.id, email = _req$body2.email, password = _req$body2.password, role = _req$body2.role;
          userData = {
            name: name,
            lastname: lastname,
            id: id,
        ...
        case 9:
          ...
          userData.role = foundRole.map(function (role) {
            return role._id;
        ...
        case 11:
          _context4.next = 13;
          return _User["default"].findByIdAndUpdate(req.params.userId, userData, {
            "new": true
          });
        case 13:
