...
var createPet = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, name, años, parentesco, fechanacimiento, imgULR, newPet, petSave;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          // ene sta funcion principal se incluye async por ser requisito del await
          console.log(req.body);
          _req$body = req.body, name = _req$body.name, años = _req$body.años, parentesco = _req$body.parentesco, fechanacimiento = _req$body.fechanacimiento, imgULR = _req$body.imgULR; // a esto se le llama reestructuri, se extraen todos los paramertros del objeto Pet.
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return _Pet["default"].findById(req.params.petId);
        case 2:
          pet = _context3.sent;
  ...
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return _Pet["default"].findByIdAndUpdate(req.params.petId, req.body, {
            "new": true
          });
        case 2:
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          ...
          _context5.next = 3;
          return _Pet["default"].findByIdAndRemove(petId);
        case 3:
          res.status(204).json();
        case 4:
        case "end":
